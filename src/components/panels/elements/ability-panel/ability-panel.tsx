...
export const AbilityPanel = (props: Props) => {
	...
	const getWarnings = () => {
		...
		if ((conditions.includes(ConditionType.Bleeding) || ((state === 'dying') && (props.ability.id !== AbilityData.catchBreath.id))) && AbilityLogic.costsStaminaWhileBleeding(props.ability)) {
			warnings.push({
